...
#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_SOCKET_ACCEPTOR_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_SOCKET_ACCEPTOR_H_
...
class SocketAcceptor : public io::EventHandler {
 public:
   ...
   */
  HandleInterface* GetHandle() { return &server_socket_; }
...
#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_SOCKET_ACCEPTOR_H_
