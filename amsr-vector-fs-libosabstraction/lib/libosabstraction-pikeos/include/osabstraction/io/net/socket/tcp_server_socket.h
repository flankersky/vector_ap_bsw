 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file
 *        \brief  Implementation of TCP sockets with server semantic.
 *
 *      \details  -
 *
 *********************************************************************************************************************/

#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_TCP_SERVER_SOCKET_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_TCP_SERVER_SOCKET_H_
 ...
 */
class TcpServerSocket : public virtual TcpServerSocketInterface, public IpSocket {
 public:
  /**
   ...
   */
  explicit TcpServerSocket(address::SocketAddressFamily address_family)
      : IpSocket(address_family, SocketType::kStream) {}
   ...
   * \brief Returns the next connection request from the queue of pending connections.
   *
   * \param[in] remote_address  The remote socket address of the next connection request.
   * \return The next connection request.
   */
...
#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_TCP_SERVER_SOCKET_H_
