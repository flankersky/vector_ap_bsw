...
#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_SOCKET_CONNECTOR_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_SOCKET_CONNECTOR_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include <sys/socket.h>  // EINPROGRESS
#include <functional>
#include <map>
#include <string>
...
class SocketConnector : public io::EventHandler {
 public:
   ...
   */
  HandleInterface* GetHandle() { return &socket_; }
  ...
  bool HandleWrite(int handle) override {
    if (handle == socket_.GetRawFiledescriptor()) {
...
#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_SOCKET_CONNECTOR_H_
