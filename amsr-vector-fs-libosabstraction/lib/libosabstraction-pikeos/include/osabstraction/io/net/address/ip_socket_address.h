...
#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_ADDRESS_IP_SOCKET_ADDRESS_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_ADDRESS_IP_SOCKET_ADDRESS_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include <lwip/netdb.h>  // getaddrinfo(), gai_strerror()
...
class IpSocketAddress : public virtual IpSocketAddressInterface, public SocketAddress {
 public:
   ...
   * \brief Creates an IP socket address.
   *
   * \param addr A pointer to the POSIX addrinfo structure containing the address information.
   */
  explicit IpSocketAddress(const struct addrinfo& addr);
};
...
#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_ADDRESS_IP_SOCKET_ADDRESS_H_
