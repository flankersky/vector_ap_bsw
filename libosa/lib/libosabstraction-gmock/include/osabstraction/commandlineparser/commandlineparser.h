 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**  \file   libosabstraction-gmock/include/osabstraction/commandlineparser/commandlineparser.h
 *   \brief  A Wrapper for an commandline parser
 *********************************************************************************************************************/

#ifndef LIB_LIBOSABSTRACTION_GMOCK_INCLUDE_OSABSTRACTION_COMMANDLINEPARSER_COMMANDLINEPARSER_H_
#define LIB_LIBOSABSTRACTION_GMOCK_INCLUDE_OSABSTRACTION_COMMANDLINEPARSER_COMMANDLINEPARSER_H_
...
#endif  // LIB_LIBOSABSTRACTION_GMOCK_INCLUDE_OSABSTRACTION_COMMANDLINEPARSER_COMMANDLINEPARSER_H_
