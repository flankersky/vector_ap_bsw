...
#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_IPC_DATAGRAM_SOCKET_BUILDER_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_IPC_DATAGRAM_SOCKET_BUILDER_H_
...
class IpcDatagramSocketBuilder : public IpcDatagramSocketBuilderInterface {
 public:
   ...
   *
   * \return     A socket not connected to any address.
   */
  IpcDatagramSocket BuildSocket(const address::IpcSocketAddress& local_address) override;

  /**
   * \brief      Creates an IPC datagram socket from a local IPC socket address,
   *             connected to the given remote address.
   *
   * \param[in]  local_address   The address to open the socket at.
   * \param[in]  remote_address  The address to connect to.
   *
   * \return     A socket connected to the given remote_address.
   */
...
#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_IPC_DATAGRAM_SOCKET_BUILDER_H_
