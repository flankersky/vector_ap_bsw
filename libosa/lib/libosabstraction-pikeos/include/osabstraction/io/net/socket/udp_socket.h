 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file
 *        \brief  Implementation of UDP socket interface.
 *
 *      \details  -
 *
 *********************************************************************************************************************/

#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_UDP_SOCKET_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_UDP_SOCKET_H_
 ...
 */
class UdpSocket : public virtual UdpSocketInterface, public IpSocket {
 public:
  /**
   * \brief Creates a UDP socket matching the given socket address family.
   */
  explicit UdpSocket(address::SocketAddressFamily address_family) : IpSocket(address_family, SocketType::kDatagram) {}
...
#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_NET_SOCKET_UDP_SOCKET_H_
