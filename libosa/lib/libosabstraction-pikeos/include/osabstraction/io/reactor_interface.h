 ...
 *      \details  This type of reactor interface does not assume handles to be integers.
 *
 *********************************************************************************************************************/

#ifndef LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_REACTOR_INTERFACE_H_
#define LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_REACTOR_INTERFACE_H_
 ...
 */
enum EventType { kNoEvent = 0, kReadEvent = 1, kWriteEvent = 2, kExceptionEvent = 4 };
...
class ReactorInterface : public vac::timer::TimerReactorInterface {
 public:
   ...
   */
  virtual void RegisterEventHandler(HandleInterface* handle, EventHandler* event_handler, unsigned int event_type_mask,
   ...
   */
  virtual void UnregisterEventHandler(HandleInterface* handle, unsigned int event_type_mask) = 0;
...
class EventHandlerRemovalHandler {
 public:
   ...
   */
  virtual void EventHandlerRemoved(int removed_handle, EventType event_type) = 0;
};

}  // namespace io
}  // namespace osabstraction

#endif  // LIB_LIBOSABSTRACTION_PIKEOS_INCLUDE_OSABSTRACTION_IO_REACTOR_INTERFACE_H_
