 ...
 * @since 1.0
 */
public class DmServerConfig_JsonJetArg extends JetArgumentJson {
    @SuppressWarnings("unused")
    private static final ILogger logger = Logger.INSTANCE.createLogger(DmServerConfig_JsonJetArg.class);
     ...
     * @param jsonModel
     */
    public DmServerConfig_JsonJetArg(final IGeneratorPackage generatorPackage, final JsonStructure jsonModel, final String baseFolder, final String serverName) {
    ...
    public String getFilename() {
        return "dm_server_config_" + serverName + ".json";
    }
