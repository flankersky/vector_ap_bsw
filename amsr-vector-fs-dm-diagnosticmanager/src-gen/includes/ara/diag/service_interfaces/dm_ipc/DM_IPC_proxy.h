...
#ifndef SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_PROXY_H_
#define SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_PROXY_H_
...
/**
 * \brief Type-alias for service method 'RequestData', that is part of the proxy.
 */
using MethodRequestData = ara::com::internal::MethodParameters<uint32&, MetaInfoType&, DataArrayType&>::ProxyMethod<
    DM_IPCProxyImplInterface, proxy::methods::RequestData, &DM_IPCProxyImplInterface::MethodRequestData>;
...
/**
 * \brief Proxy class for the service 'DM_IPC'.
 * \remark generated
 */
class DM_IPCProxy {
 public:
  /**
   * \brief Constructor of DM_IPCProxy. The communication management shall provide a constructor for each
   ...
   * DM_IPCProxy::FindService or asynchronous DM_IPCProxy::StartFindService.
   */
  explicit DM_IPCProxy(const ara::com::HandleType& handle);
   ...
   */
  virtual ~DM_IPCProxy() = default;

  /**
   * \brief Get the unique proxy type identifier. Unique for the service 'DM_IPC'.
  ...
  /**
   * \brief Get the DM_IPCProxyImplInterface of this proxy to get access to the binding-specific implementation
   ...
   */
  DM_IPCProxyImplInterface& GetServiceProxyImplInterface() { return *service_interface_.get(); }
 ...
 private:
  ...
  /**
   * \brief Helper method to construct the binding-related DM_IPCProxyImplInterface
   ...
   */
  static std::unique_ptr<DM_IPCProxyImplInterface> ConstructInterface(const ara::com::HandleType& handle);
  ...
  std::unique_ptr<DM_IPCProxyImplInterface> service_interface_;

 public:
  /* ---- Methods -------------------------------------------------------------------------------------------------- */

  /**
   * \brief Service method 'RequestData' as an object of an instantiated proxy.
   ...
   */
  proxy::methods::MethodRequestData RequestData;
...
#endif  // SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_PROXY_H_
