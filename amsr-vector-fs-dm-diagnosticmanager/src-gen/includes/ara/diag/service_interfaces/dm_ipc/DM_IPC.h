...
#ifndef SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_H_
#define SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_H_
...
#endif  // SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_H_
