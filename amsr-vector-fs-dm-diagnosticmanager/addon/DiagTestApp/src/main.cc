 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  amsr-vector-fs-dm-diagnosticmanager/addon/DiagTestApp/src/main.cc
 *        \brief  TODO
 *
 *      \details  -
 *
...
int main(int argc, char* argv[]) {
  /* Parse arguments */
  diag_test_application::CommandLineArguments args = diag_test_application::ArgumentsParser::ParseArguments(argc, argv);

  /* Initialize Logger */
  ara::log::InitLogging("DiagTestApplication", "AdaptiveApplication for testing Diagnostics.", args.verbosity_level,
                        ara::log::LogMode::kConsole, "log");
  /* Create the application object */
  diag_test_application::DiagTestApplication application;
