 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_skeleton.h
...
#ifndef ADDON_DIAGTESTAPP_SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_SKELETON_H_
#define ADDON_DIAGTESTAPP_SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_SKELETON_H_
...
class DataIdentifier_SWCL_A_DID_4711Skeleton;
...
/**
 * \brief Skeleton interface class for the service 'DataIdentifier_SWCL_A_DID_4711'.
 * \remark generated
 */
class DataIdentifier_SWCL_A_DID_4711Skeleton : public ara::com::internal::SkeletonBase,
 ...
 public:
   ...
   * from this object.
   */
  using SkeletonImplUniquePtr = std::unique_ptr<DataIdentifier_SWCL_A_DID_4711SkeletonImplInterface>;
  ...
  /**
   * \brief Constructor of DataIdentifier_SWCL_A_DID_4711Skeleton.
   ...
   */
  explicit DataIdentifier_SWCL_A_DID_4711Skeleton(
   ...
   */
  virtual ~DataIdentifier_SWCL_A_DID_4711Skeleton() = default;

  /**
   * \brief Get the unique skeleton type identifier. Unique for the service 'DataIdentifier_SWCL_A_DID_4711'.
  ...
  /**
   * \brief Offer the service 'DataIdentifier_SWCL_A_DID_4711'.
   */
  void OfferService();

  /**
   * \brief Stop offering the service 'DataIdentifier_SWCL_A_DID_4711'.
   */
   ...
   */
  virtual ara::com::Future<skeleton::methods::Write::Output> Write(const MetaInfoType& MetaInfo,
                                                                   const uint8& dataRecord_DataElement_one,
                                                                   const uint16& dataRecord_DataElement_two) = 0;
...
#endif  // ADDON_DIAGTESTAPP_SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_SKELETON_H_
