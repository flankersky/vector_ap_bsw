 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_F190_someip_skeleton_factory.h
...
#ifndef ADDON_DIAGTESTAPP_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SOMEIP_SKELETON_FACTORY_H_
#define ADDON_DIAGTESTAPP_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SOMEIP_SKELETON_FACTORY_H_
...
/**
 * \brief Factory class to instantiate the SOME/IP backend for service 'DataIdentifier_SWCL_A_DID_F190'
 * \remark generated
 */
class DataIdentifier_SWCL_A_DID_F190SomeIpSkeletonFactory
 ...
 public:
   ...
   */
  explicit DataIdentifier_SWCL_A_DID_F190SomeIpSkeletonFactory(
  ...
  ::someip_posix_common::someip::ServiceId GetSomeIpServiceId() const override {
    return DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpBinding::kServiceId;
  }
  ...
  /**
   * \brief Factory method to create SOME/IP binding backend for service 'DataIdentifier_SWCL_A_DID_F190'
   ...
   * \return A ProxyImplInterface for service 'DataIdentifier_SWCL_A_DID_F190' for the given instance ID.
   */
...
#endif  // ADDON_DIAGTESTAPP_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SOMEIP_SKELETON_FACTORY_H_
