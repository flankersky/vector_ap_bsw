 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_F190_skeleton_someip_binding.h
 *        \brief  SOME/IP binding of service skeleton for service 'DataIdentifier_SWCL_A_DID_F190'
 *
 *      \details
 *
 *********************************************************************************************************************/

#ifndef ADDON_DIAGTESTAPP_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SKELETON_SOMEIP_BINDING_H_
#define ADDON_DIAGTESTAPP_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SKELETON_SOMEIP_BINDING_H_
...
#include "ara/diag/service_interfaces/data_identifier_F190/DataIdentifier_SWCL_A_DID_F190_skeleton_someip_event_manager.h"
...
class DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpBinding
    : public DataIdentifier_SWCL_A_DID_F190SkeletonImplInterface,
 ...
 public:
   ...
   */
  explicit DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpBinding(
   ...
   */
  ~DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpBinding();
  ...
  ara::com::internal::SkeletonId GetSkeletonId() const override {
    return DataIdentifier_SWCL_A_DID_F190Skeleton::GetSkeletonIdStatic();
  }

  /**
   * \brief Getter for accessing the related frontend skeleton.
   */
  DataIdentifier_SWCL_A_DID_F190Skeleton& GetSkeleton() const { return skeleton_; }
 ...
 private:
  ...
  DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpMethodManagerRead method_manager_Read_;

  /** Method request/response manager for skeleton method 'Write' */
  DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpMethodManagerWrite method_manager_Write_;

  /** Method request/response manager for skeleton method 'Cancel' */
  DataIdentifier_SWCL_A_DID_F190SkeletonSomeIpMethodManagerCancel method_manager_Cancel_;
...
#endif  // ADDON_DIAGTESTAPP_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SKELETON_SOMEIP_BINDING_H_
