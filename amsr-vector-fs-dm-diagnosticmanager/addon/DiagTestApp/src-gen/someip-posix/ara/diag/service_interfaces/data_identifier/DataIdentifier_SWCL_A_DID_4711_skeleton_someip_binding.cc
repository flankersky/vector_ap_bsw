 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_skeleton_someip_binding.cc
...
DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpBinding::DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpBinding(
...
void DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpBinding::HandleMethodRequest(
  ...
  switch (method_id) {
    case DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpMethodManagerRead::kMethodId: {
      method_manager_Read_.HandleMethodRequest(header, std::move(deserializer));
      break;
    }
    case DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpMethodManagerWrite::kMethodId: {
      method_manager_Write_.HandleMethodRequest(header, std::move(deserializer));
      break;
    }
    case DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpMethodManagerCancel::kMethodId: {
...
void DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpBinding::SendMethodResponse(
    ::someip_posix_common::someip::SomeIpPacket&& packet) {
  someip_binding_.SendMethodRequest(instance_id_, std::move(packet));
}

void DataIdentifier_SWCL_A_DID_4711SkeletonSomeIpBinding::SendEventNotification(
    ::someip_posix_common::someip::SomeIpPacket&& packet) {
