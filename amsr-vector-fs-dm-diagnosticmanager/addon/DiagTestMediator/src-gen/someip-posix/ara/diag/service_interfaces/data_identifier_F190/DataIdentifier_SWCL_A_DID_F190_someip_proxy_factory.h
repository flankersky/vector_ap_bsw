 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_F190_someip_proxy_factory.h
 *        \brief  SOME/IP proxy factory for service 'DataIdentifier_SWCL_A_DID_F190'
 *
 *      \details
 *
 *********************************************************************************************************************/

#ifndef ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SOMEIP_PROXY_FACTORY_H_
#define ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SOMEIP_PROXY_FACTORY_H_
 ...
 * \remark generated
 */
class DataIdentifier_SWCL_A_DID_F190SomeIpProxyFactory
 ...
 public:
   ...
   */
  explicit DataIdentifier_SWCL_A_DID_F190SomeIpProxyFactory(
  ...
  ::someip_posix_common::someip::ServiceId GetSomeIpServiceId() const override {
    return DataIdentifier_SWCL_A_DID_F190ProxySomeIpBinding::kServiceId;
  }
...
#endif  // ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_F190_DATAIDENTIFIER_SWCL_A_DID_F190_SOMEIP_PROXY_FACTORY_H_
