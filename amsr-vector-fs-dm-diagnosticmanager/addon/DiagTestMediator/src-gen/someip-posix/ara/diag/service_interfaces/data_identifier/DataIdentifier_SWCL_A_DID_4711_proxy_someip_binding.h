 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_proxy_someip_binding.h
 *        \brief  SOME/IP binding of service proxy for service 'DataIdentifier_SWCL_A_DID_4711'
 *
 *      \details
 *
 *********************************************************************************************************************/

#ifndef ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_PROXY_SOMEIP_BINDING_H_
#define ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_PROXY_SOMEIP_BINDING_H_
...
#include "ara/diag/service_interfaces/data_identifier/DataIdentifier_SWCL_A_DID_4711_proxy_someip_event_manager.h"
...
/**
 * \brief SOME/IP proxy binding of Service 'DataIdentifier_SWCL_A_DID_4711'.
 * \details Handles serialization and deserialization of all method calls, events, etc.
 * \remark generated
 */
class DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding : public DataIdentifier_SWCL_A_DID_4711ProxyImplInterface,
 ...
 public:
   ...
   */
  explicit DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding(
   ...
   */
  virtual ~DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding();
   ...
   */
  ara::com::Future<proxy::methods::Write::Output> MethodWrite(MetaInfoType& MetaInfo, uint8& dataRecord_DataElement_one,
                                                              uint16& dataRecord_DataElement_two) override {
    return method_manager_Write_.HandleMethodRequest(MetaInfo, dataRecord_DataElement_one, dataRecord_DataElement_two);
  }
 ...
 private:
  ...
  DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead method_manager_Read_;

  /** Method request/response manager for proxy method 'Write' */
  DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite method_manager_Write_;

  /** Method request/response manager for proxy method 'Cancel' */
  DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel method_manager_Cancel_;
...
#endif  // ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_PROXY_SOMEIP_BINDING_H_
