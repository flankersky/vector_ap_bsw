 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DM_IPC_skeleton_someip_binding.h
 *        \brief  SOME/IP binding of service skeleton for service 'DM_IPC'
 *
 *      \details
 *
 *********************************************************************************************************************/

#ifndef ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_SKELETON_SOMEIP_BINDING_H_
#define ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_SKELETON_SOMEIP_BINDING_H_
...
#include "ara/diag/service_interfaces/dm_ipc/DM_IPC_skeleton_someip_event_manager.h"
 ...
 * \remark generated
 */
class DM_IPCSkeletonSomeIpBinding : public DM_IPCSkeletonImplInterface,
 ...
 public:
   ...
   */
  explicit DM_IPCSkeletonSomeIpBinding(::someip_posix_common::someip::InstanceId instance_id,
   ...
   */
  DM_IPCSkeleton& GetSkeleton() const { return skeleton_; }
 ...
 private:
  ...
  /* ---- Methods manager ------------------------------------------------------------------------------------------ */
  /** Method request/response manager for skeleton method 'RequestData' */
  DM_IPCSkeletonSomeIpMethodManagerRequestData method_manager_RequestData_;
...
#endif  // ADDON_DIAGTESTMEDIATOR_SRC_GEN_SOMEIP_POSIX_ARA_DIAG_SERVICE_INTERFACES_DM_IPC_DM_IPC_SKELETON_SOMEIP_BINDING_H_
