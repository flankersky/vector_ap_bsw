 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_proxy_someip_binding.cc
...
constexpr someip_posix_common::someip::ServiceId DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kServiceId;
constexpr someip_posix_common::someip::MajorVersion DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kMajorVersion;

DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding(
    ...
    : instance_id_(instance_id),
      ...
      logger_(ara::log::CreateLogger("DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding", "")),
  ...
  someip_binding_.RegisterProxyBinding(
      std::make_tuple(DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kServiceId, instance_id_, client_id_), this);
}

DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::~DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding() {
  someip_binding_.DeRegisterProxyBinding(
      std::make_tuple(DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kServiceId, instance_id_, client_id_));
}

void DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::SendMethodRequest(
    someip_posix_common::someip::SomeIpPacket&& packet) {
  someip_binding_.SendMethodRequest(instance_id_, std::move(packet));
}

void DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::SubscribeEvent(
  ...
  if (insert_pair.second) {
    someip_binding_.SubscribeEvent(DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kServiceId, instance_id_,
                                   event_id);
  } else {
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::UnsubscribeEvent(someip_posix_common::someip::EventId event_id) {
  ara::com::someip_posix::ServiceProxySomeIpEventInterface* event_manager = nullptr;
  {
    ...
    if (it != event_subscriptions_.end()) {
      ...
      someip_binding_.UnsubscribeEvent(DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kServiceId, instance_id_,
                                       event_id);
    }
  }
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::HandleMethodResponse(
  ...
  switch (method_id) {
    case DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead::kMethodId: {
      method_manager_Read_.HandleMethodResponse(header, std::move(deserializer));
      break;
    }
    case DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite::kMethodId: {
      method_manager_Write_.HandleMethodResponse(header, std::move(deserializer));
      break;
    }
    case DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel::kMethodId: {
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::HandleEventNotification(
    const ::someip_posix_common::someip::SomeIpMessageHeader& header, RootDeserializerAlias&& deserializer) {
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::HandleEventSubscriptionStateUpdate(
