 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_proxy_someip_method_manager.cc
 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "ara/diag/service_interfaces/data_identifier/DataIdentifier_SWCL_A_DID_4711_proxy_someip_method_manager.h"
#include <utility>
...
DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead::DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead(
...
DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead::HandleMethodRequest(MetaInfoType& MetaInfo) {
  ...
  header.service_id_ = DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding::kServiceId;
...
class DeserializeDataIdentifier_SWCL_A_DID_4711ReaddataRecord_DataElement_one {
 public:
  explicit DeserializeDataIdentifier_SWCL_A_DID_4711ReaddataRecord_DataElement_one(RootDeserializer* root)
      : deserializer_{root} {}
...
template <typename RootDeserializer>
class DeserializeDataIdentifier_SWCL_A_DID_4711ReaddataRecord_DataElement_two {
 public:
  explicit DeserializeDataIdentifier_SWCL_A_DID_4711ReaddataRecord_DataElement_two(RootDeserializer* root)
      : deserializer_{root} {}
...
template <typename RootDeserializer>
class DeserializeDataIdentifier_SWCL_A_DID_4711ReaderrorContext {
 public:
  explicit DeserializeDataIdentifier_SWCL_A_DID_4711ReaderrorContext(RootDeserializer* root) : deserializer_{root} {}
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead::HandleMethodResponse(
  ...
  if (message_type == someip_posix_common::someip::SomeIpMessageType::kResponse &&
    ...
    p.set_exception(std::make_exception_ptr(ara::com::ServiceNotAvailableException("DataIdentifier_SWCL_A_DID_4711")));
  } else {
...
template <typename RootDeserializer>
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead::HandleMethodResponseOk(RootDeserializer&& deserializer,
                                                                                        Promise&& p) {
  ...
  DeserializeDataIdentifier_SWCL_A_DID_4711ReaddataRecord_DataElement_one<typename std::decay<RootDeserializer>::type>
  ...
  DeserializeDataIdentifier_SWCL_A_DID_4711ReaddataRecord_DataElement_two<typename std::decay<RootDeserializer>::type>
  ...
  ret.dataRecord_DataElement_one = dataRecord_DataElement_one;
  ret.dataRecord_DataElement_two = dataRecord_DataElement_two;
...
template <typename RootDeserializer>
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerRead::HandleMethodResponseUDSServiceFailedOnRead(
  ...
  DeserializeDataIdentifier_SWCL_A_DID_4711ReaderrorContext<typename std::decay<RootDeserializer>::type>
...
DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite::
    DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite(
        DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding& proxy_binding)
    : next_session_id_(0U), proxy_binding_(proxy_binding) {}

ara::com::Future<proxy::methods::Write::Output>
DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite::HandleMethodRequest(MetaInfoType& MetaInfo,
                                                                                 uint8& dataRecord_DataElement_one,
                                                                                 uint16& dataRecord_DataElement_two) {
  ara::log::LogDebug() << __func__;
   ...
   * (/AUTOSAR_Platform/ImplementationDataTypes/uint8) */
  {
    ...
    serializer_dataRecord_DataElement_one.PushBack(dataRecord_DataElement_one);
   ...
   * (/AUTOSAR_Platform/ImplementationDataTypes/uint16) */
  {
    ...
    serializer_dataRecord_DataElement_two.PushBack(dataRecord_DataElement_two);
...
template <typename RootDeserializer>
class DeserializeDataIdentifier_SWCL_A_DID_4711WriteerrorContext {
 public:
  explicit DeserializeDataIdentifier_SWCL_A_DID_4711WriteerrorContext(RootDeserializer* root) : deserializer_{root} {}
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite::HandleMethodResponse(
    const ::someip_posix_common::someip::SomeIpMessageHeader& header, RootDeserializerAlias&& deserializer) {
  // Shortening
  namespace marshaller = someip_posix_common::someip::serialization;
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite::HandleMethodResponseOk(Promise&& p) {
...
template <typename RootDeserializer>
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerWrite::HandleMethodResponseUDSServiceFailedOnWrite(
    RootDeserializer&& deserializer, Promise&& p) {
  // Deserialize application error context arguments
  // Create one deserializer object for argument errorContext
  DeserializeDataIdentifier_SWCL_A_DID_4711WriteerrorContext<typename std::decay<RootDeserializer>::type>
      arg_errorContext_deserializer{&deserializer};
  UDSResponseCodeType errorContext = arg_errorContext_deserializer.StartDeserialization();
...
DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel::
    DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel(
        DataIdentifier_SWCL_A_DID_4711ProxySomeIpBinding& proxy_binding)
    : next_session_id_(0U), proxy_binding_(proxy_binding) {}

ara::com::Future<proxy::methods::Cancel::Output>
DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel::HandleMethodRequest(MetaInfoType& MetaInfo) {
  ara::log::LogDebug() << __func__;
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel::HandleMethodResponse(
    const ::someip_posix_common::someip::SomeIpMessageHeader& header, RootDeserializerAlias&& deserializer) {
  // Shortening
  namespace marshaller = someip_posix_common::someip::serialization;
  // Deserializer is not used in this particular case, because there is no return value to deserialize.
...
void DataIdentifier_SWCL_A_DID_4711ProxySomeIpMethodManagerCancel::HandleMethodResponseOk(Promise&& p) {
