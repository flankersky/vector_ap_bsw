 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoutineControl_SWCL_A_RID_3009_proxy_someip_binding.cc
...
constexpr someip_posix_common::someip::ServiceId RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::kServiceId;
constexpr someip_posix_common::someip::MajorVersion RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::kMajorVersion;

RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding(
    ...
    : instance_id_(instance_id),
      ...
      logger_(ara::log::CreateLogger("RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding", "")),
  ...
  someip_binding_.RegisterProxyBinding(
      std::make_tuple(RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::kServiceId, instance_id_, client_id_), this);
}

RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::~RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding() {
  someip_binding_.DeRegisterProxyBinding(
      std::make_tuple(RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::kServiceId, instance_id_, client_id_));
}

void RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::SendMethodRequest(
    someip_posix_common::someip::SomeIpPacket&& packet) {
  someip_binding_.SendMethodRequest(instance_id_, std::move(packet));
}

void RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::SubscribeEvent(
  ...
  if (insert_pair.second) {
    someip_binding_.SubscribeEvent(RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::kServiceId, instance_id_,
                                   event_id);
  } else {
...
void RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::UnsubscribeEvent(someip_posix_common::someip::EventId event_id) {
  ara::com::someip_posix::ServiceProxySomeIpEventInterface* event_manager = nullptr;
  {
    ...
    if (it != event_subscriptions_.end()) {
      ...
      someip_binding_.UnsubscribeEvent(RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::kServiceId, instance_id_,
                                       event_id);
    }
  }
...
void RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::HandleMethodResponse(
  ...
  switch (method_id) {
    case RoutineControl_SWCL_A_RID_3009ProxySomeIpMethodManagerStart::kMethodId: {
      method_manager_Start_.HandleMethodResponse(header, std::move(deserializer));
      break;
    }
    case RoutineControl_SWCL_A_RID_3009ProxySomeIpMethodManagerStop::kMethodId: {
      method_manager_Stop_.HandleMethodResponse(header, std::move(deserializer));
      break;
    }
    case RoutineControl_SWCL_A_RID_3009ProxySomeIpMethodManagerRequestResults::kMethodId: {
      method_manager_RequestResults_.HandleMethodResponse(header, std::move(deserializer));
      break;
    }
    default: {
...
void RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::HandleEventNotification(
    const ::someip_posix_common::someip::SomeIpMessageHeader& header, RootDeserializerAlias&& deserializer) {
...
void RoutineControl_SWCL_A_RID_3009ProxySomeIpBinding::HandleEventSubscriptionStateUpdate(
