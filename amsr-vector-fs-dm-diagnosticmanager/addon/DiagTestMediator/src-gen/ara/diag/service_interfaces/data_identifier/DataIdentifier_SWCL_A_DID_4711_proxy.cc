 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_proxy.cc
...
ara::com::internal::ProxyIdObject DataIdentifier_SWCL_A_DID_4711Proxy::proxy_id_;

/** StartFindService observer for the DataIdentifier_SWCL_A_DID_4711Proxy */
ara::com::internal::ServiceUpdateObserver DataIdentifier_SWCL_A_DID_4711Proxy::findservice_observer_;

DataIdentifier_SWCL_A_DID_4711Proxy::DataIdentifier_SWCL_A_DID_4711Proxy(const ara::com::HandleType& handle)
...
ara::com::FindServiceHandle DataIdentifier_SWCL_A_DID_4711Proxy::StartFindService(
...
void DataIdentifier_SWCL_A_DID_4711Proxy::StopFindService(ara::com::FindServiceHandle handle) {
  ara::com::internal::BindingPool& binding_pool = ara::com::Runtime::getInstance().GetBindingPool();
  binding_pool.StopFindService(handle);
  findservice_observer_.DeleteObserver(handle);
}

ara::com::ServiceHandleContainer<ara::com::HandleType> DataIdentifier_SWCL_A_DID_4711Proxy::FindService(
    ara::com::InstanceIdentifier instance) {
  ara::com::internal::BindingPool& binding_pool = ara::com::Runtime::getInstance().GetBindingPool();
  return binding_pool.FindService(GetProxyIdStatic(), instance);
}

std::unique_ptr<DataIdentifier_SWCL_A_DID_4711ProxyImplInterface>
DataIdentifier_SWCL_A_DID_4711Proxy::ConstructInterface(const ara::com::HandleType& handle) {
  ...
  DataIdentifier_SWCL_A_DID_4711ProxyImplInterface* concrete =
      dynamic_cast<DataIdentifier_SWCL_A_DID_4711ProxyImplInterface*>(proxy_interface.get());
  ...
  return std::unique_ptr<DataIdentifier_SWCL_A_DID_4711ProxyImplInterface>(concrete);
}
