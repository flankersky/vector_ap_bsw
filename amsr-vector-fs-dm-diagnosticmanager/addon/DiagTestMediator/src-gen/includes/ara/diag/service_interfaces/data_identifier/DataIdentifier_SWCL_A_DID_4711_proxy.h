 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  DataIdentifier_SWCL_A_DID_4711_proxy.h
 *        \brief  Proxy for service 'DataIdentifier_SWCL_A_DID_4711'.
 *
 *      \details
 *
 *********************************************************************************************************************/

#ifndef ADDON_DIAGTESTMEDIATOR_SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_PROXY_H_
#define ADDON_DIAGTESTMEDIATOR_SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_PROXY_H_
...
#include "ara/diag/service_interfaces/data_identifier/DataIdentifier_SWCL_A_DID_4711_proxy_impl_interface.h"
...
using MethodRead = ara::com::internal::MethodParameters<MetaInfoType&>::ProxyMethod<
    DataIdentifier_SWCL_A_DID_4711ProxyImplInterface, proxy::methods::Read,
    &DataIdentifier_SWCL_A_DID_4711ProxyImplInterface::MethodRead>;

/**
 * \brief Type-alias for service method 'Write', that is part of the proxy.
 */
using MethodWrite = ara::com::internal::MethodParameters<MetaInfoType&, uint8&, uint16&>::ProxyMethod<
    DataIdentifier_SWCL_A_DID_4711ProxyImplInterface, proxy::methods::Write,
    &DataIdentifier_SWCL_A_DID_4711ProxyImplInterface::MethodWrite>;
...
using MethodCancel = ara::com::internal::MethodParameters<MetaInfoType&>::ProxyMethod<
    DataIdentifier_SWCL_A_DID_4711ProxyImplInterface, proxy::methods::Cancel,
    &DataIdentifier_SWCL_A_DID_4711ProxyImplInterface::MethodCancel>;
...
/**
 * \brief Proxy class for the service 'DataIdentifier_SWCL_A_DID_4711'.
 * \remark generated
 */
class DataIdentifier_SWCL_A_DID_4711Proxy {
 public:
  /**
   * \brief Constructor of DataIdentifier_SWCL_A_DID_4711Proxy. The communication management shall provide a constructor
   * for each
   ...
   * DataIdentifier_SWCL_A_DID_4711Proxy::FindService or asynchronous
   * DataIdentifier_SWCL_A_DID_4711Proxy::StartFindService.
   */
  explicit DataIdentifier_SWCL_A_DID_4711Proxy(const ara::com::HandleType& handle);
   ...
   */
  virtual ~DataIdentifier_SWCL_A_DID_4711Proxy() = default;

  /**
   * \brief Get the unique proxy type identifier. Unique for the service 'DataIdentifier_SWCL_A_DID_4711'.
  ...
  /**
   * \brief Get the DataIdentifier_SWCL_A_DID_4711ProxyImplInterface of this proxy to get access to the binding-specific
   * implementation
   ...
   */
  DataIdentifier_SWCL_A_DID_4711ProxyImplInterface& GetServiceProxyImplInterface() { return *service_interface_.get(); }
 ...
 private:
  ...
  /**
   * \brief Helper method to construct the binding-related DataIdentifier_SWCL_A_DID_4711ProxyImplInterface
   ...
   */
  static std::unique_ptr<DataIdentifier_SWCL_A_DID_4711ProxyImplInterface> ConstructInterface(
  ...
  std::unique_ptr<DataIdentifier_SWCL_A_DID_4711ProxyImplInterface> service_interface_;
...
#endif  // ADDON_DIAGTESTMEDIATOR_SRC_GEN_INCLUDES_ARA_DIAG_SERVICE_INTERFACES_DATA_IDENTIFIER_DATAIDENTIFIER_SWCL_A_DID_4711_PROXY_H_
