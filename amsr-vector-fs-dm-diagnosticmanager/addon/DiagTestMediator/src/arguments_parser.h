 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  amsr-vector-fs-dm-diagnosticmanager/addon/DiagTestMediator/src/arguments_parser.h
 *        \brief  TODO
 *
 *      \details  TODO
 *
...
#ifndef ADDON_DIAGTESTMEDIATOR_SRC_ARGUMENTS_PARSER_H_
#define ADDON_DIAGTESTMEDIATOR_SRC_ARGUMENTS_PARSER_H_
...
/**
 * \brief Implementation of ArgumentsParser for the Mediator executable.
 */
...
#endif  // ADDON_DIAGTESTMEDIATOR_SRC_ARGUMENTS_PARSER_H_
