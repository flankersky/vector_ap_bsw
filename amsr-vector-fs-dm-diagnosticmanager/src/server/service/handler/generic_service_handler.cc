 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  generic_service_handler.cc
 *        \brief  TODO
 *
 *      \details  TODO
 *
...
#include "generic_service_handler.h"
...
GenericServiceHandler::GenericServiceHandler(const Configuration config) {
  processor_factory_.reserve(config.base.max_number_of_service_processors);
}

processor::ServiceProcessor::Ptr GenericServiceHandler::CreateServiceProcessor(
