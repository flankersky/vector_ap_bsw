...
#ifndef SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_SUBSCRIPTION_PENDING_H_
#define SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_SUBSCRIPTION_PENDING_H_
 ...
 */
class ServiceDiscoveryClientEventgroupStateSubscriptionPending : public ServiceDiscoveryClientEventgroupState {
 public:
  /**
   * \brief Constructor of ServiceDiscoveryClientEventgroupStateSubscriptionPending.
   */
  ServiceDiscoveryClientEventgroupStateSubscriptionPending();
  /**
...
#endif  // SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_SUBSCRIPTION_PENDING_H_
