...
#ifndef SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_SERVER_SERVICE_DISCOVERY_SERVER_STATE_MAIN_H_
#define SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_SERVER_SERVICE_DISCOVERY_SERVER_STATE_MAIN_H_
 ...
 */
class ServiceDiscoveryServerStateMain : public ServiceDiscoveryServerState {
 public:
  /**
   * \brief ServiceDiscoveryServerStateMain
   */
  ServiceDiscoveryServerStateMain();
 ...
 private:
  /**
   * \brief true if optimization according to [PRS_SOMEIPSD_00423] is used, false by default.
   */
  bool message_optimization_used_{false};

  /**
   * \brief timestamp of the latest sent offer. Used only if message_optimization_used_ is true.
   */
  std::chrono::time_point<vac::timer::Timer::Clock> latest_offer_timestamp_{vac::timer::Timer::Clock::now()};
};
...
#endif  // SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_SERVER_SERVICE_DISCOVERY_SERVER_STATE_MAIN_H_
