...
#ifndef SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_SERVER_SERVICE_DISCOVERY_SERVER_STATE_REPETITION_H_
#define SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_SERVER_SERVICE_DISCOVERY_SERVER_STATE_REPETITION_H_
 ...
 */
class ServiceDiscoveryServerStateRepetition : public ServiceDiscoveryServerState {
 public:
  /**
   * \brief ServiceDiscoveryServerStateRepetition
   */
  ServiceDiscoveryServerStateRepetition();
 ...
 private:
  /**
   * \brief index of the current repetition.
   */
  std::size_t current_repetition_;

  /**
   * \brief duration of the current repetition delay.
   */
  vac::timer::Timer::Clock::duration current_repetition_delay_;

  FRIEND_TEST(ServiceDiscoveryServerStateRepetitionFixture, OnEnter);
  FRIEND_TEST(ServiceDiscoveryServerStateRepetitionFixture, OnTimeOut);
};
...
#endif  // SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_SERVER_SERVICE_DISCOVERY_SERVER_STATE_REPETITION_H_
