...
#ifndef SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_FIND_SERVICE_SERVICE_DISCOVERY_CLIENT_STATE_INITIAL_WAIT_PHASE_H_
#define SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_FIND_SERVICE_SERVICE_DISCOVERY_CLIENT_STATE_INITIAL_WAIT_PHASE_H_
 ...
 */
class ServiceDiscoveryClientStateInitialWaitPhase : public ServiceDiscoveryClientState {
 public:
   ...
   */
  ServiceDiscoveryClientStateInitialWaitPhase();
  /**
 ...
 private:
   ...
   *
   * \param context A state context.
   * \return A random initial delay.
   */
  TimerDelay GetRandomInitialDelay(ServiceDiscoveryClientStateContext& context) const;
  /**
   * \brief Our logger.
   */
...
#endif  // SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_FIND_SERVICE_SERVICE_DISCOVERY_CLIENT_STATE_INITIAL_WAIT_PHASE_H_
