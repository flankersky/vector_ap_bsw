 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  service_discovery_client_eventgroup_state_machine_context.h
 *        \brief  TODO
 *
 *      \details  TODO
 *
...
#ifndef SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_MACHINE_CONTEXT_H_
#define SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_MACHINE_CONTEXT_H_
...
/**
 * \brief A Service Discovery Client eventgroup machine context.
 */
class ServiceDiscoveryClientEventgroupStateMachineContext {
 public:
  /**
   * \brief A timer delay.
   */
  ...
  /**
   * \brief Destructor of ServiceDiscoveryClientEventgroupStateMachineContext.
   */
  virtual ~ServiceDiscoveryClientEventgroupStateMachineContext() = default;
  /**
...
#endif  // SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_MACHINE_CONTEXT_H_
