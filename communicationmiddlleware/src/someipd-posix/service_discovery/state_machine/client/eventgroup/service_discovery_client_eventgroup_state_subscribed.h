...
#ifndef SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_SUBSCRIBED_H_
#define SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_SUBSCRIBED_H_
 ...
 */
class ServiceDiscoveryClientEventgroupStateSubscribed : public ServiceDiscoveryClientEventgroupState {
 public:
  /**
   * \brief Constructor of ServiceDiscoveryClientEventgroupStateSubscribed.
   */
  ServiceDiscoveryClientEventgroupStateSubscribed();
  /**
...
#endif  // SRC_SOMEIPD_POSIX_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_EVENTGROUP_SERVICE_DISCOVERY_CLIENT_EVENTGROUP_STATE_SUBSCRIBED_H_
