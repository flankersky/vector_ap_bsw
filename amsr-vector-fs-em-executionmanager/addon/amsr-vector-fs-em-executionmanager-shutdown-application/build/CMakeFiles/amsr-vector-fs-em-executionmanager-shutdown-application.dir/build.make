...
CMAKE_SOURCE_DIR = /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build
...
CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.o: ../run.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.o -c /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/run.cc
...
CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/run.cc > CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.i
...
CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/run.cc -o CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/run.s
...
amsr-vector-fs-em-executionmanager-shutdown-application: /usr/local/lib/libvac.a
amsr-vector-fs-em-executionmanager-shutdown-application: CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable amsr-vector-fs-em-executionmanager-shutdown-application"
...
CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/depend:
	cd /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build /home/njl/AP/BSW/amsr-vector-fs-em-executionmanager/addon/amsr-vector-fs-em-executionmanager-shutdown-application/build/CMakeFiles/amsr-vector-fs-em-executionmanager-shutdown-application.dir/DependInfo.cmake --color=$(COLOR)
